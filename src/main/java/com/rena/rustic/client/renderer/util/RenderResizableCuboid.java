...
public class RenderResizableCuboid {
    ...
    public void renderCubeTop(Model3D cube, PoseStack matrix, VertexConsumer buffer, int argb, int light, int packedOverlay) {
        ...
        if (sprite != null) {
            ...
            for (int uIndex = 0; uIndex < sizeU; uIndex++) {
                ...
                for (int vIndex = 0; vIndex < sizeV; vIndex++) {
                    ...
                    renderPoint(matrix4f, buffer, face, u, v, other, uv, xyz, true, false, red, green, blue, alpha, light, packedOverlay);
                    renderPoint(matrix4f, buffer, face, u, v, other, uv, xyz, true, true, red, green, blue, alpha, light, packedOverlay);
                    renderPoint(matrix4f, buffer, face, u, v, other, uv, xyz, false, true, red, green, blue, alpha, light, packedOverlay);
                    renderPoint(matrix4f, buffer, face, u, v, other, uv, xyz, false, false, red, green, blue, alpha, light, packedOverlay);
                    renderPoint(matrix4f, buffer, opposite, u, v, other, uv, xyz, false, false, red, green, blue, alpha, light, packedOverlay);
                    renderPoint(matrix4f, buffer, opposite, u, v, other, uv, xyz, false, true, red, green, blue, alpha, light, packedOverlay);
                    renderPoint(matrix4f, buffer, opposite, u, v, other, uv, xyz, true, true, red, green, blue, alpha, light, packedOverlay);
                    renderPoint(matrix4f, buffer, opposite, u, v, other, uv, xyz, true, false, red, green, blue, alpha, light, packedOverlay);
                }
            }
        }
        matrix.popPose();
     ...
     */
    public void renderCube(Model3D cube, PoseStack matrix, VertexConsumer buffer, int argb, int light, int packedOverlay) {
        float red = RenderUtils.getRed(argb);
        float green = RenderUtils.getGreen(argb);
        float blue = RenderUtils.getBlue(argb);
        float alpha = RenderUtils.getAlpha(argb);
    ...
    private void renderPoint(Matrix4f matrix4f, VertexConsumer buffer, Direction face, Direction.Axis u, Direction.Axis v, float other, float[] uv, float[] xyz, boolean minU, boolean minV,
                             float red, float green, float blue, float alpha, int light, int packedOverlay) {
        ...
        buffer.vertex(matrix4f, vertex.x(), vertex.y(), vertex.z()).color(red, green, blue, alpha).uv(uv[uFinal], uv[vFinal]).uv2(light).normal(0, 1,0).overlayCoords(packedOverlay).endVertex();
    }
}
