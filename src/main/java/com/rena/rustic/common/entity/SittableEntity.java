package com.rena.rustic.common.entity;

import com.rena.rustic.core.EntityInit;
...
public class SittableEntity extends Entity
{
    ...
    private SittableEntity(Level level, BlockPos source, double yOffset, Direction direction)
    {
        this(level);
